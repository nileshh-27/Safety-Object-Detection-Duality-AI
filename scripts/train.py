...
if __name__ == '__main__': 
    ...
    results = model.train(
        ...
        epochs=args.epochs,
        device=0,
        batch=args.batch, # <-- ADD THIS
        project="/content/drive/MyDrive/Duality_Hackathon/runs/train", # <-- ADD THIS to set save folder
        name="exp", # <-- ADD THIS to name the experiment
